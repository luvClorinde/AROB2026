...
EXPERIMENT_DATE = "2025-12-30" # resultフォルダ名となる
GRAPH_NAMES: Sequence[str] = ["jpair"]
OBJECTIVES: Sequence[str] = ("MELD", "MOA", "EDD", "PQ")
VALUE_RANGE: list = [20, 30, 50]  # 制御点の探索範囲を定める上下限を決めます。
...
class NSGA2EdgeBundlingExperiment:
    ...
    def __init__(
        ...
        self.results_dir = results_dir / "PCHIP" / f"value_range_{VALUE_RANGE[i]}"
